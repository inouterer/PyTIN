...
from sample_data import point_in, trn_in, real, real_levels, user_bounds, real_bounds, kgs1, kgs1_bounds
...
surface.custom_bounds = input_data(kgs1_bounds)
